...
This project uses third-party software components. Below is a list of these components, their licenses, and where to find their original license terms.

## 1. Backend & Server-Side Libraries (NuGet)
...
| Component | License | Status in Repository |
| :--- | :--- | :--- |
| **Bootstrap Icons** | MIT | Local `LICENSE` file present |
| **Microsoft SignalR (client)** | Apache 2.0 | Local `LICENSE.txt` file present |
